            ...
            <div className="text-brown-700 grid grid-cols-2 gap-4">
                <div className="col-span-2 md:col-span-1 h-fit">
                    ...
                    <div className="bg-brown-100 p-8 rounded-xl shadow-md">
                        <h2 className="text-3xl text-brown-900 mb-4">
                            Ingredients
                        </h2>
                ...
                <div className="bg-brown-100 p-8 rounded-xl shadow-md col-span-2 md:col-span-1">
                    ...
                    <ol className="list-decimal pl-10">
                        ...
                        <li>
                            In a large mixing bowl, combine the oats, nuts
                            and/or seeds, salt and spices. Stir to blend.
                        </li>
                        <li>
                            Pour in the oil and/or sweeteners. Mix well, until
                            every oat and nut is lightly coated. Pour the
                            granola onto your prepared pan and use a large spoon
                            to spread it in an even layer.
                        </li>
                        <li>
                            Bake until lightly golden, about 21 to 24 minutes,
                            stirring halfway (for extra-clumpy granola, press
                            the stirred granola down with your spatula to create
                            a more even layer). The granola will further crisp
                            up as it cools.
                        </li>
                        <li>
                            Let the granola cool completely, undisturbed (at
                            least 45 minutes). Top with the dried fruit (and
                            optional chocolate chips, if using). Break the
                            granola into pieces with your hands if you want to
                            retain big chunks, or stir it around with a spoon if
                            you don’t want extra-clumpy granola.
                        </li>
                        <li>
                            Store the granola in an airtight container at room
                            temperature for 1 to 2 weeks, or in a sealed freezer
                            bag in the freezer for up to 3 months. The dried
                            fruit can freeze solid, so let it warm to room
