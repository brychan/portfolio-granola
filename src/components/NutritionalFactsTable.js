  ...
  return (
    <div className="font-sans w-full bg-brown-100 text-brown-700 p-5 md:p-2 lg:p-4 rounded-lg border-brown-700 border-2">
      ...
      <div className="flex justify-between items-end font-extrabold my-2 text-brown-900">
        <div>
          <div className="lg:text-3xl md:text-2xl text-3xl">Calories</div>
        </div>
      ...
      <div className="border-t-4 border-black text-md pb-1">
        ...
        <div className="flex justify-between">
          <div>Monounsaturated Fat {portion.fat_mono.toFixed(2)}g</div>
          <div className="font-bold">{dataTable.cDV.fat_mono}%</div>
        </div>
        <div className="flex justify-between">
          <div>Polyunsaturated Fat {portion.fat_poly.toFixed(2)}g</div>
        ...
        <div className="flex justify-between">
          ...
          <div className="font-bold">{dataTable.cDV.carbs_fiber}%</div>
        </div>
        <hr className="border-gray-500" />
        <div className="pl-4">
...
function calculateNutrition(data) {
  ...
  data.forEach((ingredient) => {
    nutrition = {
      ...
      fat: nutrition.fat + (ingredient.nutrition.fat * ingredient.amount) / 100,
      fat_sat:
        nutrition.fat_sat +
