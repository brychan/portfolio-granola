...
const _categories = {
  Cereals: {
    ...
    image: <img src={cerealsImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
  Nuts: {
    bg: "bg-red-100 ",
    text: "text-red-300 ",
    ...
    image: <img src={nutsImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
  Oils: {
    bg: "bg-yellow-100 ",
    ...
    image: <img src={oilsImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
  Sweetener: {
    bg: "bg-yellow-100 ",
    text: "text-yellow-200 ",
    ...
    image: <img src={sweetenerImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
  Toppings: {
    bg: "bg-yellow-100 ",
    text: "text-yellow-200 ",
    ...
    image: <img src={toppingsImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
  Seeds: {
    bg: "bg-yellow-100 ",
    text: "text-yellow-200 ",
    ...
    image: <img src={seedsImg} alt="" className="w-2/5 m-auto self-center mt-5" />,
  },
};
