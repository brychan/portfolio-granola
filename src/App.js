    ...
    return (
        <Fragment>
            <section className="min-h-fit">
                <div className="container text-center">
                    ...
                    <h1 className="text-2xl md:text-4xl font-sans mx-8 lg:mx-40 mt-12 md:mt-16 text-brown-700">
                        Start your journey to the perfect bowl of crunchy,
                        healthy and cheap{' '}
                ...
                <div className="custom-shape-divider-bottom-1649326114">
                    {shapeDividerHome}
                </div>
            </section>
            ...
            <section className="min-h-screen bg-brown-100">
                <div
                    className="custom-shape-divider-top-1649189188"
                    id="calculator"
                    ref={calculatorRef}
                >
                    {shapeDividerCalculator}
            ...
            <section className="bg-brown-200">
                <div
                    className="custom-shape-divider-top-1649243111"
                    id="recipe"
                    ref={recipeRef}
                >
                    {shapeDividerRecipes}
            ...
            <section className="bg-brown-900">
                <div className="container text-brown-100 py-12 font-light">
                    * Disclaimer: This is a Porfolio website, ingredients, their
                    health benefits and nutritional values may not be accurate.
                </div>
            </section>
        </Fragment>
    )
